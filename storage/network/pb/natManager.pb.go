...
func (m *NatConnect) GetNatServer() string {
	if m != nil {
		return m.NatServer
	}
	return ""
...
func (m *NatConnect) GetPublic() string {
	if m != nil {
		return m.Public
	}
	return ""
...
func (m *NatConnect) GetTargetId() string {
	if m != nil {
		return m.TargetId
	}
	return ""
...
func (m *NatConnect) GetTargetPort() int32 {
	if m != nil {
		return m.TargetPort
	}
	return 0
...
func (m *NatConnect) GetFromId() string {
	if m != nil {
		return m.FromId
	}
	return ""
...
func (m *NatConnectAck) Reset()         { *m = NatConnectAck{} }
func (m *NatConnectAck) String() string { return proto.CompactTextString(m) }
func (*NatConnectAck) ProtoMessage()    {}
func (*NatConnectAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_2f5cc5a30f7d4657, []int{3}
}

func (m *NatConnectAck) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_NatConnectAck.Unmarshal(m, b)
}
func (m *NatConnectAck) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_NatConnectAck.Marshal(b, m, deterministic)
}
func (m *NatConnectAck) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NatConnectAck.Merge(m, src)
}
func (m *NatConnectAck) XXX_Size() int {
	return xxx_messageInfo_NatConnectAck.Size(m)
}
func (m *NatConnectAck) XXX_DiscardUnknown() {
	xxx_messageInfo_NatConnectAck.DiscardUnknown(m)
}

var xxx_messageInfo_NatConnectAck proto.InternalMessageInfo

func (m *NatConnectAck) GetPublic() string {
	if m != nil {
		return m.Public
	}
	return ""
...
func (m *NatConnectAck) GetSessionId() string {
	if m != nil {
		return m.SessionId
	}
	return ""
...
func (m *NatConnectAck) GetTargetId() string {
	if m != nil {
		return m.TargetId
	}
	return ""
...
type SimpleNatInfo struct {
	NatInfo              string   `protobuf:"bytes,1,opt,name=natInfo,proto3" json:"natInfo,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *SimpleNatInfo) Reset()         { *m = SimpleNatInfo{} }
func (m *SimpleNatInfo) String() string { return proto.CompactTextString(m) }
func (*SimpleNatInfo) ProtoMessage()    {}
func (*SimpleNatInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_2f5cc5a30f7d4657, []int{12}
}

func (m *SimpleNatInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SimpleNatInfo.Unmarshal(m, b)
}
func (m *SimpleNatInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SimpleNatInfo.Marshal(b, m, deterministic)
}
func (m *SimpleNatInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SimpleNatInfo.Merge(m, src)
}
func (m *SimpleNatInfo) XXX_Size() int {
	return xxx_messageInfo_SimpleNatInfo.Size(m)
}
func (m *SimpleNatInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_SimpleNatInfo.DiscardUnknown(m)
}

var xxx_messageInfo_SimpleNatInfo proto.InternalMessageInfo

func (m *SimpleNatInfo) GetNatInfo() string {
	if m != nil {
		return m.NatInfo
	}
	return ""
...
func (*NatMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_2f5cc5a30f7d4657, []int{13}
}
...
func init() {
	...
	proto.RegisterType((*NatConnectAck)(nil), "net.pb.NatConnectAck")
	...
	proto.RegisterType((*SimpleNatInfo)(nil), "net.pb.SimpleNatInfo")
...
var fileDescriptor_2f5cc5a30f7d4657 = []byte{
	...
	,
}
